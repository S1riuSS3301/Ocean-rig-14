tips-dataset-1 = При воспламенении нажмите на сигнал справа, чтобы выполнить алгоритм: остановка, падение, катание.
tips-dataset-2 = Вы можете в любое время просмотреть и отредактировать все комбинации клавиш, используемые в игре, через меню настроек.
tips-dataset-3 = Вы можете получить доступ к внутриигровому руководству через escape-меню или нажав Numpad 0 по умолчанию.
tips-dataset-4 = С некоторыми объектами в игре связаны записи в путеводителе, которые вы можете просмотреть, изучив объект и щелкнув значок со знаком вопроса.
tips-dataset-5 = Артефакты обладают способностью оказывать постоянное воздействие на некоторые запущенные узлы, в том числе превращаться в интерком или чрезвычайно эффективный генератор.
...
tips-dataset-138 =Будучи исследователем, остерегайтесь Блуждающих. Хоть они и малы, но могут быстро вывести вас из строя, если ужалят несколько раз. Никогда не выходите на задание в одиночку.

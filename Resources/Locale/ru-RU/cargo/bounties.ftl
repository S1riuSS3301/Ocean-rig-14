...
bounty-item-drifter = Блуждающий
bounty-item-fish = Рыба

bounty-description-artifact = SolGov находится в затруднительном положении из-за кражи артефактов с планет, не практикующих космические полёты. Верните один, и мы выплатим за него компенсацию.
...
bounty-description-drifter = Мы недавно получили образец ‘Токсина Блуждающих’. Компания Interdyne заинтересована в… фармацевтическом применении. Пришлите нам несколько созданий, которые его производят.
bounty-description-fish = Гильдия рыбаков нуждается в свежей рыбе для своего банкета. Вы же морской порт, мы уверены, что вы сможете её достать.

...
department-Civilian-description = Выполняйте небольшие полезные задания для поддержания нормальной и сытой работы платформы.
...
department-Engineering-description = Поддерживайте наличие электроэнергии и целостность платформы.
department-Medical-description = Поддерживайте здоровье экипажа.
department-Security-description = Поддерживайте порядок на платформе.
...
department-Specific-description = Должности, которые есть не на всех платмофрмах.
